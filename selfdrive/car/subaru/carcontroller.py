...
class CarController():
  ...
  def update(self, c, CS, frame, actuators, pcm_cancel_cmd, visual_alert, left_line, right_line, left_lane_depart, right_lane_depart):
    ...
    if CS.CP.carFingerprint in PREGLOBAL_CARS:
      ...
      if c.longActive and CS.out.brakePressed and CS.car_follow == 0 and CS.out.standstill:
        pcm_cancel_cmd = True
    ...
    if self.CP.carFingerprint in PREGLOBAL_CARS:
      ...
      if self.es_lkas_cnt != CS.es_lkas_msg["Counter"]:
        can_sends.append(subarucan.create_es_lkas(self.packer, CS.es_lkas_msg, c.longActive, visual_alert, left_line, right_line, left_lane_depart, right_lane_depart))
